  ...
  return <section className="py-20">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-16 fade-in-up">
          ...
          <p className="text-xl text-gray-600">Toutes les réponses aux questions que vous vous posez sur nos clôtures en aluminium.</p>
        </div>

        <div className="fade-in-up">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="bg-white rounded-2xl shadow-lg border-0 px-6 py-2">
