  ...
  return <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          return <div key={benefit.title} className={`bg-white p-8 rounded-2xl shadow-lg fade-in-up`} style={{
        ...
        <div className="bg-gradient-to-r from-brand-green to-brand-green/80 p-8 rounded-3xl shadow-xl max-w-5xl mx-auto fade-in-up">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-white/90 mb-4">Nos palissades sont fabriqués selon les plus hauts standards de qualité, garantissant durabilité et esthétique exceptionnelles.</p>
            </div>
